package io.jauth.demo.auth;

import io.jauth.demo.auth.RsaKeyPairGenerator;

/**
 * Main class for generating RSA key pairs for JWT RS256/RS384/RS512 signing.
 * This class can be run to generate Base64 encoded RSA public and private keys
 * for use in JWT token signing with asymmetric encryption.
 */
